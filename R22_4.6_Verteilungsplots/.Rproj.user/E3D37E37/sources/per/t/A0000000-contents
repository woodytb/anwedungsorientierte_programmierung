...
meta <- read.csv("R64d_Meta.csv", na.strings = c("-1111.1", "-2222.2"))
gesundheit <- read.csv("Gesundheit.csv", na.strings = c("-1111.1", "-2222.2"))
...
# t3_start
boxplot(gesundheit[, 1:6],
        col = farben,
        main = "Boxplot der ersten 6 Gesundheitsvariablen",
        las = 2)  # las = 2 für vertikale Beschriftung
...
# t4_start
boxplot(Prim_Care_Phys_Rate ~ HPSA_Ind,
        data = gesundheit,
        main = "Ärzte pro 100k Einwohner nach HPSA-Indikator",
        xlab = "HPSA Indikator",
        ylab = "Anzahl Ärzte pro 100k",
