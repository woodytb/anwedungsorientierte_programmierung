...
# Ersetze den vierten Wert durch 658
werte_modifiziert <- replace(werte, 4, 658)

# Berechne den Mittelwert und den Median
w_anders_mittel <- mean(werte_modifiziert)
w_anders_median <- median(werte_modifiziert)
