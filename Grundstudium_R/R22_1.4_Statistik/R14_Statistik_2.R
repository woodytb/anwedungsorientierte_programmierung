...
# Bestimme die Sortierreihenfolge basierend auf 'hoehe'
sortierreihenfolge <- order(hoehe)

# Sortiere 'dicke' entsprechend der Sortierreihenfolge von 'hoehe'
dickeSortiert <- dicke[sortierreihenfolge]

# Sortiere 'hoehe' (optional, falls du die sortierte Höhe auch benötigst)
hoeheSortiert <- hoehe[sortierreihenfolge]
